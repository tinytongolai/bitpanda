...
@CucumberOptions(
    features = "src/test/resources/features/io/cucumber/testng/automationpractice-workflow.feature",
...
public class RunCucumberTestWorkflow extends AbstractTestNGCucumberTests {
